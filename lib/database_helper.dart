...
class DBHelper {
  ...
  static Future _onCreate(Database db, int version) async {
    ///this is to create table ntp database
    ///and the command table is same as SQL statement
...
///So now, i done all CRUD function and DB initialization
///So next, build UI for contact listing
